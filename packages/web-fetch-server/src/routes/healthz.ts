 ...
 * @see packages/web-fetch-server/src/0003a-web-fetch-api-contract.md — GET /healthz
 * @see packages/web-fetch-server/src/0003b-web-fetch-types.md — HealthResponse
 */
